...
import { Flex, Button, Box, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerBody, Input, Image, InputGroup, InputLeftElement, Menu, MenuButton, MenuItem, MenuList, IconButton, Heading, Stack, Text, ButtonGroup, SimpleGrid, Hide } from '@chakra-ui/react';
...
function LandingPage(props) {
  ...
  console.log(`ini dari datacarttt :`, dataCart);
    ...
    <>
      ...
      >
        <Text fontSize='4xl' fontWeight='bold' color='white' p={{ base: '8', lg: '4' }}>
          ...
          <Text fontSize='4xl' fontWeight='bold' color='#537FE7' pb={{ base: '-10', }} pt='-5'>Let's shopping on PETSHOP</Text>
        </Text>
      ...
      <Flex mx={2} my="-10">
        <Box mr="2">
          <Flex minHeight="100vh" maxW='8xs' flexWrap='wrap' justifyContent='space-evenly' alignItem='start'>
            <SimpleGrid columns={[1, 2, 3]} spacing={2} padding>
              {printAllProducts()}
            </SimpleGrid>
        ...
        <Hide below='2xl'>
          <Box my={-5} flex={{ base: 'none', lg: '1' }} >
            <TableCashier w="2" dataCart={dataCart} setDataCart={setDataCart} />
          </Box>
        </Hide>
      </Flex>
      {/* RIGHT CONTENT */}
